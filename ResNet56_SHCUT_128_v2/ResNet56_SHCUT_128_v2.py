...
tf.keras.utils.plot_model(model, "ResNet56_SHCUT_128.png", show_shapes=True)
...
history=tf.keras.callbacks.CSVLogger("ResNet56_SHCUT_128_history_log.csv", separator=",", append=False)
