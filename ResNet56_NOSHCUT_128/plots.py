...
fig.savefig(fname='D:\Loss\ResNet20_SHCUT_128\images\loss_Acc_ResNet20_SHCUT.pdf',
...
with h5py.File(r'D:\Loss\ResNet20_SHCUT_128\3d_surface_file_ResNet20_SHCUT_128.h5','r') as f:
    ...
    plt.title('ResNet20_SHCUT')
    fig.savefig(fname='D:\Loss\ResNet20_SHCUT_128\images\D3_surface_plot_ResNet20_SHCUT.pdf',
                  dpi=300, bbox_inches='tight', format='pdf')
    ...
    plt.title('ResNet20_SHCUT')
    fig_2.savefig(fname='D:\Loss\ResNet20_SHCUT_128\images\D2_contor_plot_ResNet20_SHCUT.pdf',
                  dpi=300, bbox_inches='tight', format='pdf')
