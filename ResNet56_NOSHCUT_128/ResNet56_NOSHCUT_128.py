...
path=r'D:\Loss\ResNet56_NOSHCUT_128'

save_dir = os.path.join(path, 'saved_models')
model_name = 'cifar10_ResNet56_NOSHCUT_128_{epoch:03d}.h5'
...
history=tf.keras.callbacks.CSVLogger("ResNet56_NOSHCUT_128_history_log.csv", separator=",", append=False)
...
tf.keras.utils.plot_model(model, "ResNet56_NOSHCUT_128.png", show_shapes=True)

loss_fn = keras.losses.CategoricalCrossentropy(from_logits=False)
#opt = tfa.optimizers.SGDW(weight_decay=0.0005,momentum=0.9, clipnorm=1.0)
