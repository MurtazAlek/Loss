...
dataset = pd.read_csv("history_log_test.csv", delimiter=",")
...
fig.savefig(fname='D:\Loss\ResNet20_SHCUT_128\images\loss_Acc.pdf',
            dpi=300, bbox_inches='tight', format='pdf')

surf_name = "test_loss"

with h5py.File(r'D:\Loss\ResNet20_SHCUT_128\3d_surface_file_test.h5','r') as f:
    ...
    fig.savefig(fname='D:\Loss\ResNet20_SHCUT_128\images\d3_surface_file_test.pdf',
                  dpi=300, bbox_inches='tight', format='pdf')
    ...
    plt.title('ResNet20_SHCUT')
    fig_2.savefig(fname='D:\Loss\ResNet20_SHCUT_128\images\D2_contor_plot_test.pdf',
                  dpi=300, bbox_inches='tight', format='pdf')
