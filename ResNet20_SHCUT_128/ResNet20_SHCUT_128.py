...
path=r'D:\Loss\ResNet20_SHCUT_WD_256'

save_dir = os.path.join(path, 'saved_models')
model_name = 'cifar10_ResNet20_SHCUT_128_{epoch:03d}.h5'
...
history=tf.keras.callbacks.CSVLogger("ResNet20_SHCUT_NOWD_128_history_log.csv", separator=",", append=False)
